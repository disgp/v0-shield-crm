...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      console.error('[v0] Failed to sign in:', error)
      setIsLoading(false)
    }
  }
        ...
        <div className="rounded-2xl bg-white px-8 py-10 shadow-lg">
          <div className="space-y-6">
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="h-14 w-full rounded-xl border-0 bg-gray-100 text-base font-medium text-gray-900 transition-all hover:bg-gray-200"
              size="lg"
            >
              {isLoading ? (
                <>
